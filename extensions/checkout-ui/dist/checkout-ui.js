...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const { extension: extension2, shop, localization } = useApi();
    const cartLines = useCartLines();
    const [firstProductId, setFirstProductId] = (0, import_react18.useState)(null);
    const [relatedProducts, setRelatedProducts] = (0, import_react18.useState)([]);
    let timerEnd;
    const [intervalInstance, setIntervalInstance] = (0, import_react18.useState)(null);
    const [timerText, setTimerText] = (0, import_react18.useState)(null);
    ...
    const intervalHandler = () => {
      ...
      if (remainingTime > 0) {
        const days = parseInt(remainingTime / 864e5);
        const hours = parseInt(remainingTime % 864e5 / 36e5);
        const minutes = parseInt(remainingTime % 36e5 / 6e4);
        const seconds = parseInt(remainingTime % 6e4 / 1e3);
    ...
    (0, import_react18.useEffect)(() => {
      const now = /* @__PURE__ */ new Date();
      const targetTime = new Date(now.getTime() + parseInt(metaSettings.cd_days) * 864e5 + parseInt(metaSettings.cd_hours) * 36e5 + parseInt(metaSettings.cd_minutes) * 6e4 + parseInt(metaSettings.cd_seconds) * 1e3);
      timerEnd = targetTime;
    ...
    (0, import_react18.useEffect)(() => {
      ...
      fetchRecommendation = (productId) => __async(this, null, function* () {
        const response = yield fetch(`https://pp-stage.heartcoding.de/home/get_recommended_products`, {
          method: "POST",
          headers: {
        ...
        if (response.ok) {
          const relatedProducts2 = yield response.json();
          if (metaSettings.exclude_ordered_products === "on") {
            let filteredProducts = relatedProducts2.products.filter((product) => {
            ...
            const products = relatedProducts2.products.map((product) => {
              return __spreadProps(__spreadValues({}, product), {
                selectedVariant: 0
              });
            });
    ...
    return relatedProducts.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { inlineAlignment: "center", spacing: "loose", padding: ["loose", "none"], children: [
      metaSettings.countdown_enabled && metaSettings.cd_position === "top" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", children: timerText }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", children: metaSettings.free_text ? metaSettings.free_text.replace(/(<([^>]+)>)/gi, "") : "" }),
      metaSettings.countdown_enabled && metaSettings.cd_position === "below_text" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", children: timerText }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineLayout2, { columns: "3", spacing: "base", children: relatedProducts.map((product, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "base", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { source: product.featured_image }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "large", appearance: "accent", children: product.title }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: formatMoney(product.variants[product.selectedVariant].price) }),
        metaSettings.variants__hide_variants === "on" ? null : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Select2,
          {
            label: "Variant",
        ...
        metaSettings.quantity_picker__hide_qty === "on" ? null : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Stepper2, { label: "Quantity", value: 1 }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Button2,
          {
            ...
            children: product.variants[product.selectedVariant].available ? metaSettings.button : metaSettings.sold_out_text
          }
        )
      ] }, index)) }),
      metaSettings.countdown_enabled && metaSettings.cd_position === "bottom" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", children: timerText }) : null
